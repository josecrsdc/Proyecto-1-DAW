...
public class PageQueHacerController implements Initializable {
    ...
    private Pack pack;
    private SpinnerValueFactory.IntegerSpinnerValueFactory plazas;
    private SpinnerValueFactory.IntegerSpinnerValueFactory duracion;
    ...
    @FXML
    private ScrollPane scrollPaneQueHacer;
    @FXML
    private AnchorPane anchorScrollQueHacer;
    @FXML
...
///////////////////////////////////////////////////////////////////////////////
    public void limpiarPantalla() {
        anchorScrollQueHacer.getChildren().clear();
    }

    public void generarLista() {
        try {
            listaActividades = actividadDAO.hacerConsulta("VISI");
        ...
        bloqueQueHacer(listaActividades);
        homeController.inicializarDatePickers(calendarioActividadInicio, calendarioActividadFin);
    }

    public void bloqueQueHacer(Set<Actividad> listaActividades) {
        ...
        while (it.hasNext()) {
            ...
            anchorScrollQueHacer.getChildren().add(paneContenedor);
            ...
            anchorScrollQueHacer.setMinHeight(posCompY + 260);
    ...
    private void duracion() {
        duracion = new SpinnerValueFactory.IntegerSpinnerValueFactory(1, 24, 1, 1);
        duracionActividad.setValueFactory(duracion);
...
///////////////////////////////////////////////////////////////////////////////
    ...
    private void aplicarFiltro(ActionEvent event) {
        ...
        if (!puntuacionCinco.isSelected() && !puntuacionCuatro.isSelected()
            ...
            bloqueQueHacer(actividadesFiltradas);
        }
    }
