...
public class PageDondeComerController implements Initializable {
    ...
    private SpinnerValueFactory.IntegerSpinnerValueFactory spinnerPlazas;
    private SpinnerValueFactory.IntegerSpinnerValueFactory spinnerDuracion;
    ...
    @FXML
    private Spinner<Integer> duracionActividad;
    @FXML
    private Label numDiasActividad;
    @FXML
    private ScrollPane scrollPaneDondeComer;
    @FXML
    private AnchorPane anchorScrollDondeComer;
    @FXML
...
///////////////////////////////////////////////////////////////////////////////
    public void limpiarPantalla() {
        anchorScrollDondeComer.getChildren().clear();
    }

    public void generarLista() {
        try {
            listaActividades = actividadDAO.hacerConsulta("COME");
        ...
        bloqueDondeComer(listaActividades);
        homeController.inicializarDatePickers(calendarioActividadInicio, calendarioActividadFin);
    }

    public void bloqueDondeComer(Set<Actividad> listaActividades) {
        ...
        while (it.hasNext()) {
            ...
            //Creacion de la imagen del restaurante
            ...
            anchorScrollDondeComer.getChildren().add(paneContenedor);
            ...
            anchorScrollDondeComer.setMinHeight(posCompY + 260);
    ...
    private void numPlazas() {
        spinnerPlazas = new SpinnerValueFactory.IntegerSpinnerValueFactory(1, 100, 1, 1);
        numPlazasActividad.setValueFactory(spinnerPlazas);
    }
    ...
    private void duracion() {
        spinnerDuracion = new SpinnerValueFactory.IntegerSpinnerValueFactory(1, 24, 1, 1);
        duracionActividad.setValueFactory(spinnerDuracion);
    }
...
///////////////////////////////////////////////////////////////////////////////
    ...
    private void agregarActividad(ActionEvent event) {
        ...
        duracion = LocalTime.of(duracionActividad.getValue(), 00);
        ...
        detallePack = new DetallePack(idPack, idActividad, sliderPrecio.getValue(), fechaHoraInicio, 
                fechaHoraFin, duracion, numeroPlazas, numDias);
    ...
    private void aplicarFiltro(ActionEvent event) {
        ...
        if (!puntuacionCinco.isSelected() && !puntuacionCuatro.isSelected()
            ...
            bloqueDondeComer(actividadesFiltradas);
        }
    }
